...
import { X, Loader2, Sparkles, Monitor, Box, Building2, HardDrive, Cpu, Network } from "lucide-react";
...
export default function KomputerModal({
  ...
  const inputPurple =
    "w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-[#066027]/20 focus:border-[#066027] outline-none text-xs text-gray-900 dark:text-white bg-white dark:bg-[#1a2e22] placeholder:text-gray-400 dark:placeholder:text-gray-500 transition-all";
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="font-extrabold text-base sm:text-lg leading-tight text-white">
                {editingId ? "Edit Data Komputer" : "Tambah Data Komputer Baru"}
              </h3>
        ...
        <form onSubmit={onSave} className="flex flex-col flex-1 overflow-hidden">
          ...
          <div className="p-4 sm:p-5 overflow-y-auto flex-1 custom-scrollbar space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-3 bg-white dark:bg-[#14261c] p-3.5 rounded-xl border border-slate-200/80 dark:border-gray-700 shadow-xs">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-2.5 items-start">
                    ...
                    {/* Produk / Model PC (dari Master Barang) */}
                    ...
                    {matchedMaster && (
                      <div className="sm:col-span-3 bg-emerald-50/90 border border-emerald-200 text-emerald-800 text-[11px] p-2 rounded-xl flex items-center justify-between gap-2 animate-in fade-in duration-200">
                        ...
                        {matchedMaster.status && (
                          <span className="text-[10px] bg-white text-emerald-700 font-bold px-2 py-0.5 rounded-full border border-emerald-200 shrink-0">
                            {matchedMaster.status}
                          </span>
                        )}
                      </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
                    <div className="sm:col-span-2">
                      ...
                      <VendorSelectDropdown
                        ...
                        vendors={vendors}
                        disabled={isSaving}
                        placeholder="Pilih atau ketik penyedia/vendor..."
                        inputCls={inputCls}
                      />
                    </div>
                    <div>
              ...
              <div className="space-y-3 bg-white dark:bg-[#14261c] p-4 rounded-xl border border-purple-100 dark:border-gray-700 shadow-xs flex flex-col justify-between">
                <div>
                  <h4 className="font-bold text-[11px] text-purple-700 dark:text-emerald-400 border-b border-purple-200/80 dark:border-white/10 pb-1.5 uppercase tracking-wide flex items-center gap-1.5 mb-3">
                    <Network className="w-3.5 h-3.5" /> Jaringan & Spesifikasi Hardware
                  </h4>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
                    <div>
                      ...
                      <input
                        ...
                        disabled={isSaving}
                        className={`${inputPurple} font-mono text-blue-700 dark:text-emerald-300 font-medium`}
                        placeholder="Contoh: 10.81.58.23"
                      />
                    </div>
                    <div>
                      ...
                      <input
                        ...
                        disabled={isSaving}
                        className={`${inputPurple} font-mono text-gray-700 dark:text-gray-300`}
                        placeholder="Contoh: ac:b4:80:12:34:56"
                      />
                    </div>
                    <div className="sm:col-span-2">
                      ...
                      <input
                        ...
                        placeholder="Misal: Intel Core i5-13600 / Ryzen 5"
                      />
                    </div>
                    <div>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        disabled={isSaving}
                        className={inputPurple}
                        placeholder="Misal: 512GB NVMe SSD"
                      />
                    </div>
                    <div className="sm:col-span-2">
                      ...
                      <input
                        ...
                        disabled={isSaving}
                        className={inputPurple}
                        placeholder="Misal: Ubuntu Pegadaian V.22 / Windows 11"
                      />
                    </div>
                    <div className="sm:col-span-2">
          ...
          <div className="px-6 py-4 bg-gray-50 dark:bg-[#03140d] border-t border-gray-100 dark:border-white/10 flex justify-end items-center gap-3 shrink-0 rounded-b-2xl sm:rounded-b-3xl">
            ...
            >
              ...
              {editingId ? "Simpan Perubahan" : "Tambah Komputer"}
            </button>
          </div>
